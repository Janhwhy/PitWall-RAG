...
radio_agent.py
--------------
Defines the RadioAgent class, a specialized BaseAgent focused on Formula 1
team radio transmissions, driver-engineer communications, commentator statements,
and decoding the strategic intent, concerns, or technical issues discussed.
"""
...
class RadioAgent(BaseAgent):
    """
    Agent specializing in team radio messages and communications analysis.
    """
    ...
    def run(self, query: str) -> dict[str, Any]:
        ...
        system_prompt = (
            "You are a Formula 1 communications analyst. You extract strategic intent, "
            "driver concerns (e.g. car handling, tyre wear, traffic), team instructions "
            "(e.g. box messages, engine modes), and commentator observations from team radio "
            "transcripts and commentator calls.\n\n"
            "RULES:\n"
        ...
        user_prompt = (
            ...
            "## Question\n"
            f"{query}\n\n"
            "Please provide a precise strategy answer focused on extracting strategic intent, driver feedback, "
            "and team instructions from the retrieved radio transcripts based strictly on the retrieved context."
        )
